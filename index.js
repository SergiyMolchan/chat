...
const userListPublishers = require('./publishers/userListPublishers');
const messagePublisher = require('./publishers/messagePublisher');
const updateUserSubscriber = require('./subscribers/updateUserSubscriber');
const newMessageSubscriber = require('./subscribers/messageSubscriber');
const app = express();
...
ws.on('connection', function connection(ws, req) {
  ...
  ws.on('message', message => {
    ...
    if (type === 'userJoinInRoom') { // user connect in roomW
      console.log('joined');
